...
namespace App
{
    public class FormSenhaExportacao : Form
    {
        ...
        public FormSenhaExportacao(bool modoExportar)
        {
        ...
        {
            Text = _modoExportar ? "Exportar senhas" : "Importar senhas";
            FormBorderStyle = FormBorderStyle.None;
            StartPosition = FormStartPosition.CenterParent;
            BackColor = Theme.CardBackground;
            DoubleBuffered = true;
            ClientSize = new Size(440, _modoExportar ? 326 : 250);
        ...
        {
            var corpo = new Panel { Dock = DockStyle.Fill, BackColor = Theme.CardBackground, Padding = new Padding(24, 16, 24, 8) };
            ...
            corpo.Controls.Add(lblInfo);

            int y = 70;
            _txtSenha = CriarCampoSenha(corpo, _modoExportar ? "Senha de exportação" : "Senha", ref y, w);

            if (_modoExportar)
                _txtConfirmar = CriarCampoSenha(corpo, "Confirmar senha", ref y, w);
            else
        ...
        private void ConfigurarRodape()
        {
            ...
            {
                Text = _modoExportar ? "Exportar" : "Importar",
