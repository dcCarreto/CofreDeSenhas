...
namespace CofreDeSenhas
{
    ...
    public static class Acessibilidade
    {
        ...
        private static readonly IReadOnlyDictionary<CorVisual, uint> PadraoClaro = D(
            (CorVisual.WorkspaceBackground, 0xFFEAEBF1),
            (CorVisual.CardBackground, 0xFFFFFFFF),
            (CorVisual.CardBorder, 0xFFECECF0),
            (CorVisual.TitleBar, 0xFFFFFFFF),
            (CorVisual.TitleBarBorder, 0xFFEEEEF1),
            (CorVisual.InputBackground, 0xFFF7F7FB),
            (CorVisual.InputBorder, 0xFFDFDFE9),
            (CorVisual.RowHover, 0xFFFAF9FE),
            (CorVisual.Separator, 0xFFF5F5F7),
            (CorVisual.Footer, 0xFFFCFCFD),
            (CorVisual.AccentPrimary, 0xFF7C3AED),
            (CorVisual.AccentHover, 0xFF6D28D9),
            (CorVisual.AccentLight, 0xFFF3EEFE),
            (CorVisual.TextPrimary, 0xFF20232B),
            (CorVisual.TextSecondary, 0xFF8D909A),
            (CorVisual.TextTertiary, 0xFFA0A0A9),
            (CorVisual.TextHeader, 0xFFA0A0A9),
            (CorVisual.TrailInactive, 0xFFE6E6EC),
            (CorVisual.ToggleOff, 0xFFD6D6DD),
            (CorVisual.HoverBackground, 0xFFF1F1F4),
            (CorVisual.IconHoverBackground, 0xFFEFEFF4),
            (CorVisual.FavoriteColor, 0xFFF5A623),
            (CorVisual.FavoriteBorderColor, 0xFFCDCDD4),
            (CorVisual.StrengthWeak, 0xFFEF4444),
            (CorVisual.StrengthMedium, 0xFFF59E0B),
            (CorVisual.StrengthStrong, 0xFF16A34A),
            (CorVisual.StrengthExcelent, 0xFF007FFF),
            (CorVisual.CloseButtonHover, 0xFFE81123),
            (CorVisual.CloseButtonPressed, 0xFFC50F1F),
            (CorVisual.StatusLocal, 0xFF22C55E),
            (CorVisual.StatusWarning, 0xFFF59E0B),
            (CorVisual.StatusConnected, 0xFF3B82F6));

        private static readonly IReadOnlyDictionary<CorVisual, uint> PadraoEscuro = D(
            (CorVisual.WorkspaceBackground, 0xFF111218),
            (CorVisual.CardBackground, 0xFF1F212A),
            (CorVisual.CardBorder, 0xFF30323D),
            (CorVisual.TitleBar, 0xFF181921),
            (CorVisual.TitleBarBorder, 0xFF2C2E39),
            (CorVisual.InputBackground, 0xFF282A35),
            (CorVisual.InputBorder, 0xFF3A3C49),
            (CorVisual.RowHover, 0xFF282A37),
            (CorVisual.Separator, 0xFF2C2E39),
            (CorVisual.Footer, 0xFF1B1C25),
            (CorVisual.AccentPrimary, 0xFF9569F4),
            (CorVisual.AccentHover, 0xFF7C3AED),
            (CorVisual.AccentLight, 0xFF372F54),
            (CorVisual.TextPrimary, 0xFFEDEEF3),
            (CorVisual.TextSecondary, 0xFF9698A4),
            (CorVisual.TextTertiary, 0xFF787A86),
            (CorVisual.TextHeader, 0xFF787A86),
            (CorVisual.TrailInactive, 0xFF383A46),
            (CorVisual.ToggleOff, 0xFF444654),
            (CorVisual.HoverBackground, 0xFF2C2E3A),
            (CorVisual.IconHoverBackground, 0xFF323440),
            (CorVisual.FavoriteColor, 0xFFF5A623),
            (CorVisual.FavoriteBorderColor, 0xFF585A67),
            (CorVisual.StrengthWeak, 0xFFEF4444),
            (CorVisual.StrengthMedium, 0xFFF59E0B),
            (CorVisual.StrengthStrong, 0xFF16A34A),
            (CorVisual.StrengthExcelent, 0xFF4DA3FF),
            (CorVisual.CloseButtonHover, 0xFFE81123),
            (CorVisual.CloseButtonPressed, 0xFFC50F1F),
            (CorVisual.StatusLocal, 0xFF22C55E),
            (CorVisual.StatusWarning, 0xFFF59E0B),
            (CorVisual.StatusConnected, 0xFF60A5FA));
        ...
        private static readonly IReadOnlyDictionary<Categoria, (uint Bg, uint Fg)> CategoriasPadrao = DCat(
            (Categoria.Personal, 0xFFEAF1FF, 0xFF2563EB),
            (Categoria.Work, 0xFFF1ECFE, 0xFF7C3AED),
            (Categoria.Finance, 0xFFE7F7EE, 0xFF16A34A),
            (Categoria.Social, 0xFFFDEAF3, 0xFFDB2777),
            (Categoria.Other, 0xFFFDEEE0, 0xFFEA580C));
        ...
        {
            0xFF7C3AED, 0xFF2563EB, 0xFF16A34A, 0xFFEA580C,
            0xFFDB2777, 0xFF0891B2, 0xFFCA8A04, 0xFFDC2626
        };
